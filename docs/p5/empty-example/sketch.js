...
function draw() {
  ...
  let magnifyingY = height / 2 - windowHeight * 0.18 + windowHeight * -0.4;
  ...
  translate(width / 2 - 50, height / 2 - windowHeight * 0.18);
...
function mousePressed() {
  ...
  let d = dist(mouseX, mouseY, width / 2 - 50, height / 2 - windowHeight * 0.18 + windowHeight * 0.325);
  if (d < windowHeight * 0.045) {
    toggleBlade = !toggleBlade;
    return;
  }
  // cek area toggle disc
  let c = dist(mouseX, mouseY, width / 2 - 50, height / 2 - windowHeight * 0.18);
  ...
  if (
    ...
    mouseX > width / 2 - 50 - windowHeight * 0.7 &&
    mouseY > height / 2 - windowHeight * 0.18 + windowHeight * 0.25 &&
    mouseY < height / 2 - windowHeight * 0.18 + windowHeight * 0.25 + windowHeight * 0.25
  ) {
    draggingBlade = true;
    return;
  }
...
function touchStarted() {
  ...
  // cek area toggle blade
  let d = dist(mouseX, mouseY, width / 2 - 50, height / 2 - windowHeight * 0.18 + windowHeight * 0.25 + windowHeight * 0.075);
  if (d < windowHeight * 0.045) {
    toggleBlade = !toggleBlade;
    return;
  }
...
function isClickInsideMagnifying() {
  let magnifyingX = width / 2 - 50;
  let magnifyingY = height / 2 - windowHeight * 0.18 + windowHeight * -0.3;
